--[[
	...
	Aimbot Module [AxisHub] by Aegians © CC0 1.0 Universal (2023)
...
if not getgenv().AxisHub or getgenv().AxisHub.Aimbot then return end
...
local Environment = getgenv().AxisHub.Aimbot
...
function Environment.Functions:Exit()
	...
	getgenv().AxisHub.Aimbot.Functions = nil
	getgenv().AxisHub.Aimbot = nil
