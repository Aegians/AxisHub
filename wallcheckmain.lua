...
if not getgenv().AxisHub or getgenv().AxisHub.WallHack then return end
...
local Environment = getgenv().AxisHub.WallHack
...
function Environment.Functions:Exit()
	...
	getgenv().AxisHub.WallHack.Functions = nil
	getgenv().AxisHub.WallHack = nil
