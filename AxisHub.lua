...
local GUI = loadstring(game:HttpGet("https://raw.githubusercontent.com/Aegians/AxisHub/main/src%20/UI.lua"))()
...
InformationSection:Button({
	Name = "Copy GitHub",
	Callback = function()
		setclipboard("https://github.com/Aegians")
	end
})
